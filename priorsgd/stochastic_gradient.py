...
from .seq_dataset import ArrayDataset, CSRDataset
...
class BaseSGDClassifier(six.with_metaclass(ABCMeta, BaseSGD,
    ...
    def _partial_fit(self, X, y, alpha, C,
        ...
        if per_feature_alpha is None and per_feature_beta is None:
            if per_feature_alpha is None:
                per_feature_alpha = np.ones( self.coef_.shape ) * alpha * (1.0 - l1_ratio)       
    ...
    def _fit(self, X, y, alpha, C, loss, learning_rate, coef_init=None,
             ...
             per_feature_alpha=None,
             per_feature_beta=None,
             modal_vector=None):
    ...
    def _fit_binary(self, X, y, alpha, C, 
                    per_feature_alpha,
                    per_feature_beta,
                    modal_vector,
                    sample_weight,
    ...
    def _fit_multiclass(self, X, y, alpha, C, 
                        per_feature_alpha,
                        per_feature_beta,
                        modal_vector,
                        learning_rate,
        ...
        result = Parallel(n_jobs=self.n_jobs, backend="threading",
            ...
            delayed(fit_binary)(self, i, X, y, alpha, C, 
                                learning_rate,
    ...
    def partial_fit(self, X, y, classes=None, sample_weight=None,
                    per_feature_alpha=None, per_feature_beta=None,
                    modal_vector=None, 
                    ):
        ...
        per_feature_alpha : array-like, shape (n_features, ), optional
        ...
        per_feature_beta : array-like, shape (n_features, ), optional
            The per feature L1 regularization strength.
            The length should be identical to the number of features.
            The scale of the strength is in per example basis.

        modal_vector : array-like, shape (n_features, ), optional
    ...
    def fit(self, X, y, coef_init=None, intercept_init=None,
            sample_weight=None, per_feature_alpha=None,
            per_feature_beta=None, 
            modal_vector=None):
        """Fit linear model with Stochastic Gradient Descent.
